...
public class CopyOfRealtimeVideoActivity extends Activity implements SurfaceHolder.Callback {
...
//	        clientInfo.lLinkMode = 0x80000000;
	...
	private static final int PLAYING_BUFFER_SIZE = 2097152;
...
//		} while ( -1 == playPort );
	    ...
	    if ( ! Player.getInstance().openStream( playPort, buffer, bufferSize, 2 * 1024 * 1024/*PLAYING_BUFFER_SIZE*/ ) ) {
